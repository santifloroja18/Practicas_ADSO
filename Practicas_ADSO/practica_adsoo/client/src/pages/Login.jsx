            ...
            <div className='row cuadradolog'>
                ...
                <div id='form' className='col-7' >
                    <div className='row justify-content-center' >
                        <div className='col-8'><h4 id='tituloLogin' className='text-center'>Inicia sesión</h4></div>
                    </div>
                    <div className='row'>
                        <div className='col-12'>
                            <form action="" method="post">
                                ...
                                <div className="row justify-content-center">
                                    ...
                                    <div className="col-4"><button className='btn btn-dark fw-bold' type="button">Iniciar Sesión</button></div>
